...
image: "/img/deadlock/logo.jpg"
description: "Расследование тормозов в многопоточном приложении"
tags:
- troubleshooting
- deadlock
- gitlab
...
hideComments: false
---
_Обложка: Multithreading в сейлинге. Ларнака, июнь 2025_
...
{{< spoiler "Под катом стектрейс sidekiq'a" >}}
...
{{< figure src="/img/deadlock/multithreading.jpg" caption="Типичная работа многопоточного приложения" >}}
...
{{< spoiler "Почему именно этот push" >}}
